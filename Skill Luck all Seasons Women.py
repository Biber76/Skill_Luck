...
seasons = [i for i in range(7, 21)] + [22, 23]
list_contribution_luck = []
for season in seasons:
    df = pd.read_csv(f'./Data/women_season{season}.csv')
...
fig.suptitle('Luck Contribution CH-Floorball Women 2007 - 2023')
...
ax[0].legend()
ax[1].legend()
plt.savefig('./Pictures/women.jpg')
plt.show()